 ...
 */
@PWA(name = "Kotlin Vaadin ", shortName = "Kotlin Vaadin ", enableInstallPrompt = false)
@Theme(themeFolder = "kotlinvaadin", variant = Lumo.DARK)
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Kotlin Vaadin  logo"));
        logoLayout.add(new H1("Kotlin Vaadin "));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Hello World 2", "la la-globe", AllInfoSearch.class), //
                new MenuItemInfo("List", "", PersonView.class), //
